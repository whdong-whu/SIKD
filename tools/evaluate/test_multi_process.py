...
class ACDC(Dataset):
    def __init__(self,
                 data_path='/home/whdong/data/medical/MICCAI2021_multi_domain_robustness_datasets/split_xu/test'):
...
if __name__ == '__main__':
    temp_path = '/home/whdong/data/medical/acdc_temp'
    os.environ["CUDA_VISIBLE_DEVICES"] = '0'
    # ckpt_path = args.save_path + 'best_model.pth'
    ckpt_path = '/home/whdong/workshop/medical/unet_siqi/logs/acdc17/kd_05d2/ckpt/model_best.pth'
    ...
    num_class = 4
    data_load = ACDC()
    # data_load = ACDC(data_path='/home/whdong/data/medical/MICCAI2021_multi_domain_robustness_datasets/MM')
    print('--------saving pred---------')
